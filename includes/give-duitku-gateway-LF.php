...
class DuitkuGatewayLF extends PaymentGateway {
	/**
	...
	public function getName(): string {
		return __( 'Duitku Link Aja Apps (Fixed Fee)', 'give-duitku' );
	}
	...
	public function getPaymentMethodLabel(): string {
		return __( 'Link Aja Apps Fixed', 'give-duitku' );
	}
	...
	public function getLegacyFormFieldMarkup( $formId, $args ) {
		return "<div class=''>
            <p>You will be redirected to Duitku Link Aja Apps (Fixed Fee) Payment Gateway</p>
        </div>";
	}
	...
	public function enqueueScript( int $formId ) {
		...
		wp_enqueue_script(
			$handle,
			plugin_dir_url( __FILE__ ) . 'js/duitku-LF-gateway.js',
			[ 'react', 'wp-element' ],
			'1.0.0',
			true );
