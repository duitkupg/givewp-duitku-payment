...
class DuitkuGatewayT1 extends PaymentGateway {
	/**
	...
	public function getName(): string {
		return __( 'Duitku Tokopedia Card Payment', 'give-duitku' );
	}
	...
	public function getPaymentMethodLabel(): string {
		return __( 'Tokopedia Card Payment', 'give-duitku' );
	}
	...
	public function getLegacyFormFieldMarkup( $formId, $args ) {
		return "<div class=''>
            <p>You will be redirected to Duitku Tokopedia Card Payment Payment Gateway</p>
        </div>";
	}
	...
	public function enqueueScript( int $formId ) {
		...
		wp_enqueue_script(
			$handle,
			plugin_dir_url( __FILE__ ) . 'js/duitku-T1-gateway.js',
			[ 'react', 'wp-element' ],
			'1.0.0',
			true );
