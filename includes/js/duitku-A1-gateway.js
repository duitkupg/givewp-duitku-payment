...
(() => {
  ...
  function DuitkuGatewayFields() {
    return window.wp.element.createElement(
      "div",
      {
        className: "duitku-atm-bersama-help-text",
      },
      window.wp.element.createElement(
        ...
        settings.message ||
          "You will be redirected to Duitku ATM Bersama VA Payment Gateway."
      ),
      window.wp.element.createElement(
        "img",
        {
          style: { 
           ...
           src : pluginUrl + "assets/images/duitkuatmbersama.png",
           alt : "ATM Bersama Logo",
        },
      ),
    );
  }
