...
(() => {
  ...
  function DuitkuGatewayFields() {
    return window.wp.element.createElement(
      "div",
      {
        className: "duitku-linkaja-apps-fixed-help-text",
      },
      window.wp.element.createElement(
        ...
        settings.message ||
          "You will be redirected to Duitku Link Aja Apps (Fixed Fee) Payment Gateway."
      ),
      window.wp.element.createElement(
        "img",
        {
          style: { 
           ...
           src : "https://images.duitku.com/hotlink-ok/LF.PNG",
           alt : "Link Aja Logo",
        },
      ),
    );
