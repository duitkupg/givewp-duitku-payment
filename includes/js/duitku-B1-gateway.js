...
(() => {
  ...
  function DuitkuGatewayFields() {
    return window.wp.element.createElement(
      "div",
      {
        className: "duitku-cimb-help-text",
      },
      window.wp.element.createElement(
        ...
        settings.message ||
          "You will be redirected to Duitku CIMB Niaga VA Payment Gateway."
      ),
      window.wp.element.createElement(
        "img",
        {
          style: { 
           ...
           src : "https://images.duitku.com/hotlink-ok/B1.PNG",
           alt : "CIMB Niaga VA Logo",
        },
      ),
    );
  }
