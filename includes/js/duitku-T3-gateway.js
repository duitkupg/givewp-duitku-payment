...
(() => {
  ...
  function DuitkuGatewayFields() {
    return window.wp.element.createElement(
      "div",
      {
        className: "duitku-tokopedia-others-help-text",
      },
      window.wp.element.createElement(
        ...
        settings.message ||
          "You will be redirected to Duitku Tokopedia Others Payment Gateway."
      ),
      window.wp.element.createElement(
        "img",
        {
          style: { 
           ...
           src : pluginUrl + "assets/images/duitku_tokopedia_others.png",
           alt : "Tokopedia Logo",
        },
      ),
    );
