...
(() => {
  ...
  function DuitkuGatewayFields() {
    return window.wp.element.createElement(
      "div",
      {
        className: "duitku-artha-graha-help-text",
      },
      window.wp.element.createElement(
        ...
        settings.message ||
          "You will be redirected to Duitku Artha Graha Payment Gateway."
      ),
      window.wp.element.createElement(
        "img",
        {
          style: { 
           ...
           src : "https://images.duitku.com/hotlink-ok/AG.JPG",
           alt : "Artha Graha Logo",
        },
      ),
    );
  }
