...
class DuitkuGatewayA1 extends PaymentGateway {
	/**
	...
	public function getName(): string {
		return __( 'Duitku ATM Bersama VA', 'give-duitku' );
	}
	...
	public function getPaymentMethodLabel(): string {
		return __( 'ATM Bersama VA', 'give-duitku' );
	}
	...
	public function getLegacyFormFieldMarkup( $formId, $args ) {
		return "<div class=''>
            <p>You will be redirected to Duitku ATM Bersama VA Gateway</p>
        </div>";
	}
	...
	public function enqueueScript( int $formId ) {
		...
		wp_enqueue_script(
			$handle,
			plugin_dir_url( __FILE__ ) . 'js/duitku-A1-gateway.js',
			[ 'react', 'wp-element' ],
			'1.0.0',
			true );
	}
