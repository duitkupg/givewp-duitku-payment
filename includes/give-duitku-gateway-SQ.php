...
class DuitkuGatewaySQ extends PaymentGateway {
	/**
	...
	public function getName(): string {
		return __( 'Duitku Nusapay QRIS', 'give-duitku' );
	}
	...
	public function getPaymentMethodLabel(): string {
		return __( 'Nusapay QRIS', 'give-duitku' );
	}
	...
	public function getLegacyFormFieldMarkup( $formId, $args ) {
		return "<div class=''>
            <p>You will be redirected to Duitku Nusapay QRIS Payment Gateway</p>
        </div>";
	}
	...
	public function enqueueScript( int $formId ) {
		...
		wp_enqueue_script(
			$handle,
			plugin_dir_url( __FILE__ ) . 'js/duitku-SQ-gateway.js',
			[ 'react', 'wp-element' ],
			'1.0.0',
			true );
