...
class DuitkuGatewayBV extends PaymentGateway {
	/**
	...
	public function getName(): string {
		return __( 'Duitku BSI VA', 'give-duitku' );
	}
	...
	public function getPaymentMethodLabel(): string {
		return __( 'Bank Syariah Indonesia VA', 'give-duitku' );
	}
	...
	public function getLegacyFormFieldMarkup( $formId, $args ) {
		return "<div class=''>
            <p>You will be redirected to Duitku Bank Syariah Indonesia Virtual Account Payment Gateway</p>
        </div>";
	}
	...
	public function enqueueScript( int $formId ) {
		...
		wp_enqueue_script(
			$handle,
			plugin_dir_url( __FILE__ ) . 'js/duitku-BV-gateway.js',
			[ 'react', 'wp-element' ],
			'1.0.0',
			true );
