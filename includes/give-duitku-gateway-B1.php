...
class DuitkuGatewayB1 extends PaymentGateway {
	/**
	...
	public function getName(): string {
		return __( 'Duitku CIMB Niaga VA', 'give-duitku' );
	}
	...
	public function getPaymentMethodLabel(): string {
		return __( 'CIMB Niaga VA', 'give-duitku' );
	}
	...
	public function getLegacyFormFieldMarkup( $formId, $args ) {
		return "<div class=''>
            <p>You will be redirected to Duitku CIMB Niaga VA Payment Gateway</p>
        </div>";
	}
	...
	public function enqueueScript( int $formId ) {
		...
		wp_enqueue_script(
			$handle,
			plugin_dir_url( __FILE__ ) . 'js/duitku-B1-gateway.js',
			[ 'react', 'wp-element' ],
			'1.0.0',
			true );
	}
